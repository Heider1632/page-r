      ...
      <div class="container">
        ...
        <div class="row align-items-center mt-5">
          ...
          <div class="col-lg-5 contact-details mt-5 mt-lg-0">
            <div class="box">
              <div class="icon d-flex align-items-end"><img src="https://d19m59y37dris4.cloudfront.net/appton/1-0/img/placeholder.svg" alt="" class="img-fluid"></div>
              <h5>Address</h5>
              <p class="text-small font-weight-light">13/25 New Avenue, New Heaven, 45Y 73J, England, Great Britain</p>
            </div>
            <div class="box">
              <div class="icon d-flex align-items-end"><img src="https://d19m59y37dris4.cloudfront.net/appton/1-0/img/technology.svg" alt="" class="img-fluid"></div>
              <h5>Call center</h5>
            ...
            <div class="box">
              <div class="icon d-flex align-items-end"><img src="https://d19m59y37dris4.cloudfront.net/appton/1-0/img/multimedia.svg" alt="" class="img-fluid"></div>
